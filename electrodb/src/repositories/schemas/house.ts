import { z } from "zod";
import { RoomElectroDBSchema } from "./room";

export const HouseElectroDBSchema = z.object({
  id: z.string().uuid(),
  createdAt: z.number(),
  updatedAt: z.number(),
  address: z.object({
  ...
  rooms: z.array(RoomElectroDBSchema),
  exterior: z.object({
    material: z.string(),
    color: z.string(),
    roofType: z.string(),
...
export type HouseElectroDB = z.infer<typeof HouseElectroDBSchema>;
